...
public class UpdateMakanan extends AppCompatActivity {
    ...
    private void getMakanan(){
        class GetMakanan extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequestParam("https://akbar9.000webhostapp.com/web_service/Makanan/get_makanan.php?no=",id);
                return s;
            }
        }
    ...
    private void updateMakanan(){
        ...
        class UpdateMakanan1 extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendPostRequest("https://akbar9.000webhostapp.com/web_service/Makanan/update_makanan.php", hashMap);
    ...
    private void deleteMakanan(){
        class DeleteMakanan extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
                RequestHandler rh = new RequestHandler();
                String s = rh.sendGetRequestParam("https://akbar9.000webhostapp.com/web_service/Makanan/delete_makanan.php?no=", id);
                return s;
            }
        }
